...
function(do_fetch)
  ...
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
...
execute_process(
  COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git show-ref "ddf20dc0480874bf02e0bdc6ded76c1f101b17fb"
  WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "ddf20dc0480874bf02e0bdc6ded76c1f101b17fb")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("ddf20dc0480874bf02e0bdc6ded76c1f101b17fb" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: ddf20dc0480874bf02e0bdc6ded76c1f101b17fb")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/ddf20dc0480874bf02e0bdc6ded76c1f101b17fb")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"ddf20dc0480874bf02e0bdc6ded76c1f101b17fb\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
...
execute_process(
  COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid'."
    ...
    execute_process(
      COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "D:/CODE/git/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/master/vr/final2/PositionBasedDynamics/build-vs2/extern/Discregrid/src/Ext_Discregrid'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
